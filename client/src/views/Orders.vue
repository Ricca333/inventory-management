          ...
          <table class="orders-table">
            ...
            <tbody>
              <tr v-for="order in submittedOrders" :key="order.id">
                ...
                <td class="col-lead">{{ getLeadTime(order) }} {{ t('restocking.days') }}</td>
...
export default {
  ...
  setup() {
    ...
    // Submitted restocking orders are shown in their own section; keep the main
    // "All Orders" table free of them to avoid duplication.
    ...
    // Delivery lead time in days: prefer the stored value, else derive from dates.
    const getLeadTime = (order) => {
      if (order.lead_time_days != null) return order.lead_time_days

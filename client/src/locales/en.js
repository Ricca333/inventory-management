export default {
  ...
  restocking: {
    ...
    recommendationsHint: 'Items with rising demand, prioritized by demand growth within your budget',
    ...
    orderPlaced: 'Restocking order {orderNumber} submitted. See it in the Orders tab.',
